...
void func_8() // Position - 0x32E (814)
{
	...
	if (!IS_BIT_SET(iLocal_62, 1) || PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL) || Global_1942966)
	{
		...
		func_165(1, 2, 1, 1, 1);
		func_164(0, 0, 0, 0, 0);
		func_163("VOM_MENU_T" /*VEHICLE ORGANIZATION*/);
		func_160();
		func_74();
	...
	{
		if (func_58(&(bLocal_78.f_5), 5000, true))
			Global_1942966 = true;
	
		if (bLocal_74 && func_58(&(bLocal_78.f_5), 2000, true))
		{
			bLocal_74 = false;
			Global_1942966 = true;
		}
...
void func_16(float fParam0, float fParam1, char* sParam2, Hash hParam3, int iParam4) // Position - 0x36A8 (13992)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL func_58(int iParam0, int iParam1, BOOL bParam2) // Position - 0x51A2 (20898)
{
	if (iParam1 == -1)
		return true;

	func_299(iParam0, bParam2, false);
...
int func_178(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x17315 (94997)
{
...
void func_193(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1866B (99947)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
...
BOOL func_194(int iParam0) // Position - 0x186A8 (100008)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_244()))
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_244(), false))
		{
			...
			{
				if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(func_244(), true), _GET_PLAYER_COORDS(PLAYER::PLAYER_ID())) < 1500f)
				{
					iLocal_76 = 6;
					return false;
				}
