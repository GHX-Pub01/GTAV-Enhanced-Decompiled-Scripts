...
BOOL func_144(Player plParam0) // Position - 0xBC1B (48155)
{
	Player player;
...
BOOL func_145(Player plParam0) // Position - 0xBC3F (48191)
{
	Player player;
...
BOOL func_146(Player plParam0, int iParam1) // Position - 0xBC5D (48221)
{
...
Hash func_192(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x139FF (80383)
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13FD1 (81873)
{
	BOOL i;
	BOOL j;
...
BOOL func_197(Ped pedParam0, int iParam1) // Position - 0x14074 (82036)
{
...
BOOL func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1412B (82219)
{
	int pedPropIndex;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x1454C (83276)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_221(entityModel, iParam1, bParam2, -1) };
	hash = Global_2883588;
			...
			if (unk[num] != -99)
			{
				if (!func_205(pedParam0, num, unk[num]))
				{
							...
							if (!func_205(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79551[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_209(entityModel, bParam2, 14, j, &unk, &Global_79551[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_221(entityModel, num, flag, -1) };
					
						if (!func_209(entityModel, bParam2, num, flag, &unk, &Global_79551[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
...
BOOL func_206(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x149A7 (84391)
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x14A50 (84560)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14AF8 (84728)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x14B4B (84811)
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1514F (86351)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x153CC (86988)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x157F1 (88049)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15AE4 (88804)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_220(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18702 (100098)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x18773 (100211)
{
	func_267();
...
int func_277(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34A12 (215570)
{
	Hash componentHash;
