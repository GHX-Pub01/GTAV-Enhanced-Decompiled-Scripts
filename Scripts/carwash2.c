...
int func_118(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x9921 (39201)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_119(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9ACE (39630)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
ePedComponentType func_129(int iParam0) // Position - 0x9EDE (40670)
{
	if (iParam0 == 1)
...
void func_228(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xDA73 (55923)
{
	BOOL flag;
	int num;
...
void func_261(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x135F4 (79348)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
