...
int func_63(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x5280 (21120)
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_115(entityModel, iParam1, epctParam2, -1) };
...
{
	Global_79551[1 /*14*/] = { func_115(hParam0, iParam1, epctParam2, -1) };
...
void func_83(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x8108 (33032)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_84(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, type, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (epctParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (epctParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (epctParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (epctParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
struct<14> func_115(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xFED8 (65240)
{
	func_178();
...
void func_116(int iParam0, ePedComponentType epctParam1) // Position - 0xFF2A (65322)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x235E4 (144868)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_115(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_179(pedParam0, 14, k))
											if (!func_69(entityModel, epctParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_115(entityModel, i, type, -1) };
					
						if (!func_69(entityModel, epctParam2, i, type, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_73(epctParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_73(epctParam1)))
	{
		return true;
	}
...
char* func_250(char* sParam0) // Position - 0x2A23D (172605)
{
	return sParam0;
}
...
void func_276(int iParam0) // Position - 0x2BCD1 (179409)
{
	int i;
	int j;
...
BOOL func_286(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2C5C2 (181698)
{
	Hash entityModel;
	int i;
	var unk;
...
void func_289(int iParam0, BOOL bParam1) // Position - 0x2C816 (182294)
{
...
int func_339(const char* sParam0) // Position - 0x325A2 (206242)
{
...
int func_341(const char* sParam0, BOOL bParam1) // Position - 0x32620 (206368)
{
	Hash hashKey;
	int num;
