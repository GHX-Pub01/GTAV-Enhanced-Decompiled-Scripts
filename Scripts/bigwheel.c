...
int func_71(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6F24 (28452)
{
	...
	if (iParam5 == 0)
	{
		Global_79551[1 /*14*/] = { func_124(entityModel, iParam1, bParam2, -1) };
...
{
	Global_79551[1 /*14*/] = { func_124(hParam0, iParam1, bParam2, -1) };
...
struct<14> func_124(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x11C3A (72762)
{
	func_187();
...
BOOL func_188(Ped pedParam0, ePedComponentType epctParam1, BOOL bParam2) // Position - 0x25663 (153187)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_124(entityModel, epctParam1, bParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_188(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79551[2 /*14*/].f_12 == j)
										if (func_188(pedParam0, 14, k))
											if (!func_77(entityModel, bParam2, 14, k, &unk, &Global_79551[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79551[2 /*14*/] = { func_124(entityModel, i, flag, -1) };
					
						if (!func_77(entityModel, bParam2, i, flag, &unk, &Global_79551[2 /*14*/]))
							return false;
					}
				}
			}
