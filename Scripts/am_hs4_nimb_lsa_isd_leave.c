...
BOOL func_194(Ped pedParam0, int iParam1) // Position - 0x13899 (80025)
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				flag = func_199(pedParam0, 11, PV_COMP_INVALID);
			
				if (flag >= 237)
				{
					componentHash = func_195(joaat("MP_M_Freemode_01"), flag, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				flag2 = func_199(pedParam0, 11, PV_COMP_INVALID);
			
				if (flag2 >= 256)
				{
					componentHash2 = func_195(joaat("MP_F_Freemode_01"), flag2, 11, 4);
...
Hash func_195(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x13B59 (80729)
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = bParam1 - func_198(hParam0);
	...
	else
	{
		...
		componentId2 = bParam1 - func_196(hParam0, func_197(iParam2));
...
BOOL func_199(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1412D (82221)
{
	BOOL i;
	BOOL j;
...
BOOL func_200(Ped pedParam0, int iParam1) // Position - 0x141CE (82382)
{
...
BOOL func_202(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14285 (82565)
{
	int pedPropIndex;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x146A6 (83622)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_224(entityModel, iParam1, bParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
		unk = { func_220(entityModel, bParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num] != -99)
			{
				if (!func_208(pedParam0, num, unk[num]))
				{
					Global_2883588 = hash;
					...
					if (num == 13)
					{
						unk18 = { func_217(entityModel, unk[num]) };
							...
							if (!func_208(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79551[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_212(entityModel, bParam2, 14, j, &unk, &Global_79551[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					{
						flag = func_200(pedParam0, num);
						Global_79551[2 /*14*/] = { func_224(entityModel, num, flag, -1) };
					
						if (!func_212(entityModel, bParam2, num, flag, &unk, &Global_79551[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
	...
	{
		unk28 = { func_217(entityModel, bParam2) };
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79550 == 1)
				if (func_211(entityModel, 11, func_200(pedParam0, 11), -1))
					if (func_210(entityModel, 4, bParam2, &flag2))
						return func_208(pedParam0, 4, flag2);
				else if (func_209(entityModel, 4, bParam2, &flag2))
					return func_208(pedParam0, 4, flag2);
...
BOOL func_209(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x14B01 (84737)
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (bParam2 >= 256)
					{
						componentHash = func_195(hParam0, bParam2, iParam1, 4);
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x14BAA (84906)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14C52 (85074)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, bParam2, 11, 4);
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x14CA5 (85157)
{
	var unk;
	int i;
	...
	if (func_216(hParam0, iParam2, bParam3))
		return true;

	if (hParam0 == joaat("Player_Zero"))
	{
		if (func_215(hParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_214(hParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_213(hParam0, iParam2, bParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x152A9 (86697)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, bParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, bParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, bParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, bParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_214(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x15526 (87334)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_215(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1594B (88395)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_216(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15C3E (89150)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_223(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1885B (100443)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_224(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x188CC (100556)
{
	func_270();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_254(iParam1, bParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_225(iParam1, bParam2, hParam3);
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag2 = func_199(pedParam0, 8, PV_COMP_INVALID);
					
						if (flag2 >= 241)
						{
							componentHash2 = func_195(joaat("MP_M_Freemode_01"), flag2, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num2 = func_280(joaat("MP_F_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag3 = func_199(pedParam0, 11, PV_COMP_INVALID);
					
						if (flag3 >= 256)
						{
							componentHash3 = func_195(joaat("MP_F_Freemode_01"), flag3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num3 = func_280(joaat("MP_F_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag4 = func_199(pedParam0, 8, PV_COMP_INVALID);
					
						if (flag4 >= 136)
						{
							componentHash4 = func_195(joaat("MP_F_Freemode_01"), flag4, 8, 4);
...
int func_280(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34D09 (216329)
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_195(hParam0, bParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_195(hParam0, bParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_195(hParam0, bParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_195(hParam0, bParam2, 8, 4);
