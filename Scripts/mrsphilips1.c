...
struct<10> func_78(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9786 (38790)
{
	int i;
	var unk;
...
struct<17> func_81(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA227 (41511)
{
	int i;
	var unk;
...
struct<14> func_85(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC37D (50045)
{
	func_149();
