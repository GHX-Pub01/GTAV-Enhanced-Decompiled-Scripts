...
BOOL func_74(int iParam0, int iParam1) // Position - 0x3B5B (15195)
{
	int i;
	...
	switch (iParam0)
	{
		...
		case 14:
			switch (iParam1)
			{
				...
				case 148:
					flag = BUILTIN::FLOOR(BUILTIN::TO_FLOAT(func_162(12025, -1) / 60));
					break;
...
{
	return func_39(526, -1) || MISC::HAS_FINALIZED_CHOSEN_CRIMINAL_CAREER() && func_128() != 0 && !func_127(0);
}
