...
Hash func_192(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x13A03 (80387)
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13FD5 (81877)
{
	BOOL i;
	BOOL j;
...
BOOL func_197(Ped pedParam0, int iParam1) // Position - 0x14077 (82039)
{
...
BOOL func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1412E (82222)
{
	int pedPropIndex;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x1454F (83279)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
...
BOOL func_206(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x149AA (84394)
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x14A53 (84563)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14AFB (84731)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x14B4E (84814)
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x15152 (86354)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x153CF (86991)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x157F4 (88052)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15AE7 (88807)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_220(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18704 (100100)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x18775 (100213)
{
	func_267();
...
int func_277(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34A19 (215577)
{
	Hash componentHash;
