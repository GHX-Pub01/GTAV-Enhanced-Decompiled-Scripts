...
void func_19() // Position - 0xFBA (4026)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114162.f_10198.f_3853))
		func_23(13, BUILTIN::FLOOR(Global_114162.f_10198.f_3853));
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, BOOL bParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F70 (36720)
{
	int num;
	...
	switch (hParam0)
	{
		...
		case 571787049:
			if (bParam1 > false || Global_262145.f_27955)
				func_117(uParam2, joaat("NET_SHOP_TTYPE_SERVICE"), joaat("NET_SHOP_ACTION_SPEND"), joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), hParam0, bParam1, num, 7);
			break;
		...
		case joaat("SERVICE_EARN_SPIN_THE_WHEEL_CASH"):
			func_117(uParam2, joaat("NET_SHOP_TTYPE_SERVICE"), 1445302971, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), hParam0, bParam1, num, 7);
			break;
	}
...
int func_117(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, BOOL bParam5, int iParam6, int iParam7) // Position - 0x98EF (39151)
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	*uParam0 = 15;
	...
	if (flag || flag2 || NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(&transactionId, hParam3, hParam4, hParam2, bParam5, iParam6))
	{
		...
		{
			*uParam0 = func_124(transactionId, iParam1, hParam4, hParam2, hParam3, bParam5, false, iParam6, iParam7, 1, true);
	...
	else
	{
		...
		if (iParam7 & 4 != 0)
			func_118(-1, hParam4, iParam6, bParam5, -1);
	}

	return 0;
}

void func_118(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x9A9C (39580)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_241(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x10066 (65638)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_242(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, flag, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
Hash func_243(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x101CE (65998)
{
	...
	else
	{
		...
		num2 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_231(iParam2));
...
int func_248(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1092A (67882)
{
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_231(iParam2));
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_243(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_243(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_243(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_243(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
void func_278(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1A2FE (107262)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_272(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_272(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_231(iParam0));
...
BOOL func_343(var uParam0) // Position - 0x2C88A (182410)
{
	...
	if (func_344(uParam0->f_12, entityRotation) > BUILTIN::COS(uParam0->f_15))
		return 1;
