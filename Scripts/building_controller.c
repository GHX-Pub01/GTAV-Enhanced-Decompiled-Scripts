	...
	if (IS_BIT_SET(Global_42895[iParam0 /*31*/].f_1, 6) || IS_BIT_SET(Global_42895[iParam0 /*31*/].f_1, 5) || func_43(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_42895[iParam0 /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_42895[iParam0 /*31*/].f_1, 1))
			{
				...
				{
					Global_42895[iParam0 /*31*/].f_22 = Global_42895[iParam0 /*31*/].f_22 - (Global_42895[iParam0 /*31*/].f_23 * BUILTIN::TIMESTEP());
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_42895[iParam0 /*31*/].f_1, 3))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
			{
				...
				{
					num = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_42895[iParam0 /*31*/].f_2);
...
void func_41(int iParam0, BOOL bParam1) // Position - 0x57FD (22525)
{
	...
	if (bParam1)
	{
		if (!IS_BIT_SET(Global_42895[num /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_42895[num /*31*/].f_1, 1))
			{
				...
				{
					Global_42895[num /*31*/].f_22 = Global_42895[num /*31*/].f_22 - (Global_42895[num /*31*/].f_23 * BUILTIN::TIMESTEP());
	...
	else if (!IS_BIT_SET(Global_42895[num /*31*/].f_1, 3))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(closestVehicle, false))
			{
				num2 = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_42895[num /*31*/].f_2);
	...
	if (Global_42895[iParam0 /*31*/].f_24 > 0)
	{
		for (i = 0; i < Global_42895[iParam0 /*31*/].f_24; i = i + 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(ped))
			{
				...
				{
					if (BUILTIN::VDIST2(Global_42895[iParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(ped, true)) < Global_42895[iParam0 /*31*/].f_6)
					{
			...
			switch (iParam0)
			{
				...
				case 4:
					if (!func_58(4, PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							case CHAR_MICHAEL:
								if (BUILTIN::VDIST2(Global_42895[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
								...
								if (func_49(2))
									if (func_49(17))
										if (func_49(19) || func_48(19))
											if (BUILTIN::VDIST2(Global_42895[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
												func_57(4, PLAYER::PLAYER_PED_ID());
									else if (BUILTIN::VDIST2(Global_42895[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
										func_57(4, PLAYER::PLAYER_PED_ID());
								break;
