...
BOOL func_235(Ped pedParam0, ePedComponentType epctParam1, BOOL bParam2) // Position - 0x233E7 (144359)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79551[1 /*14*/] = { func_171(entityModel, epctParam1, bParam2, -1) };
	...
	else if (Global_79551[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_133(epctParam1)) && Global_79551[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_133(epctParam1)))
	{
		return true;
	}
