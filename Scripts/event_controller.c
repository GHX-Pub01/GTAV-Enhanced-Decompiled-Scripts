...
Hash func_26(var uParam0) // Position - 0xFEF (4079)
{
	Hash hash;
	int num;
...
Hash func_34(Player plParam0, int iParam1) // Position - 0x15A5 (5541)
{
	if (func_24(iParam1))
	{
		if (Global_2628534)
...
int func_36(Hash hParam0) // Position - 0x17BE (6078)
{
	switch (hParam0)
	{
		case 15:
...
BOOL func_44(BOOL bParam0) // Position - 0x22F3 (8947)
{
...
BOOL func_111(int iParam0) // Position - 0x36A3 (13987)
{
	return Global_1574538[iParam0];
}

BOOL func_112() // Position - 0x36B3 (14003)
{
