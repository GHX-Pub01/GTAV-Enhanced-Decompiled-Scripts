...
void func_354(int* piParam0) // Position - 0x1AFF7 (110583)
{
	if (piParam0->f_9 != 0)
	{
...
void func_390(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1FB01 (129793)
{
	int num;
	float num2;
	float num3;
...
void func_393(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x1FD76 (130422)
{
	int num;
...
void func_405(ePedComponentType epctParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2022D (131629)
{
	int num;
	float num2;
	float num3;
...
BOOL func_475(int* piParam0) // Position - 0x2252C (140588)
{
	switch (piParam0->f_9)
	{
		case 0:
